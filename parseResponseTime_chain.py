...
import plotResponseTimeChain


def writeEachClient(pathClient, client):
...
def main():
    ...
    for exp in os.listdir(pathExperiment):
        ...
        if os.path.isdir(exp_path) and exp != '.DS_Store' and exp != 'stats':
            ...
            pathClient='../experiments/'+`experimentID`+'/'+exp+'/C'
            ...
            for dir_entry in os.listdir(pathClient):
                ...
                if os.path.isfile(dir_entry_path) and dir_entry != 'allclients' and dir_entry != '.DS_Store':
                    ...
                    writeEachClient(pathClient, clientID)
            ...
            # Compute standard deviation of response time for all client
                ...
                allClientStats = open(pathExperiment+'/stats/allclients_RT.stat', 'a')
    ...
    plotResponseTimeChain.main(experimentID, inThread, outThread, noOfMW, poolSize)
